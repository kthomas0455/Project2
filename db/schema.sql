...
(
	...
	artistNumber INT(12) NOT NULL,
	indepndent varchar(20) NOT NULL,
	shopName varchar(50) NOT NULL,
	hourlyRate varchar(10) NOT NULL,
	artistMin varchar(10) NOT NULL,
